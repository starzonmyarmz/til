---
title: "A Select default must match the option type"
date: 2026-04-30
description: "A boolean default won’t pick an option whose value is a string. Pick one type end-to-end, normalize at the boundary, and don’t mutate props on the way through."
